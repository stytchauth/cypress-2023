...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      ): Cypress.Chainable<AddVirtualAuthenticatorResult>;
      ...
      ): Cypress.Chainable<ClearCredentialsResult>;
      ...
      ): Cypress.Chainable<RemoveCredentialResult>;
      ...
      ): Cypress.Chainable<RemoveVirtualAuthenticatorResult>;
      ...
      ): Cypress.Chainable<SetAutomaticPresenceSimulationResult>;

      /**
       * Resets parameters isBogusSignature, isBadUV, isBadUP to false if they are not present.
       */
      webauthnSetResponseOverrideBits(
        params: SetResponseOverrideBitsParams
      ): Cypress.Chainable<SetResponseOverrideBitsResult>;
      ...
      ): Cypress.Chainable<SetUserVerifiedResult>;
    }
  }
}
